...
function GoogleG() {
  return (
    <svg width="14" height="14" viewBox="0 0 48 48" aria-hidden>
      <path
        fill="#4285F4"
        d="M45 24.5c0-1.6-.1-3.1-.4-4.5H24v9h11.8c-.5 2.7-2 5-4.3 6.6v5.5h7c4.1-3.8 6.5-9.4 6.5-16.6z"
      />
      <path
        fill="#34A853"
        d="M24 46c5.8 0 10.7-1.9 14.3-5.2l-7-5.5c-1.9 1.3-4.4 2.1-7.3 2.1-5.6 0-10.4-3.8-12.1-8.9H4.7v5.6C8.3 41.2 15.6 46 24 46z"
      />
      <path
        fill="#FBBC05"
        d="M11.9 28.5c-.4-1.3-.7-2.7-.7-4.1s.3-2.8.7-4.1v-5.6H4.7C3.2 17.6 2.3 20.7 2.3 24s.9 6.4 2.4 9.3l7.2-4.8z"
      />
      <path
        fill="#EA4335"
        d="M24 9.5c3.2 0 6 1.1 8.3 3.2l6.2-6.2C34.7 3.1 29.8 1 24 1 15.6 1 8.3 5.8 4.7 13l7.2 5.6C13.6 13.3 18.4 9.5 24 9.5z"
      />
    </svg>
  );
}
